		...
		<div style="display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
			...
			<c:choose>
				<c:when test="${sessionScope.isAdmin}">
					<a href="${pageContext.request.contextPath}/admin/toggle" style="color:#ffe4a8;">관리자 ON</a>
				...
				<c:otherwise>
					<a href="${pageContext.request.contextPath}/admin/toggle" style="color:#ffe4a8;">관리자 OFF</a>
				</c:otherwise>
			</c:choose>
		</div>
	</div>
