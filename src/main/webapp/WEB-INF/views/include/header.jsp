...
<div class="header">
    <div class="header-inner">
        ...
        <form class="search-box" action="${cp}/book/list" method="get">
            <input type="text" name="keyword" placeholder="도서명, 저자, 출판사로 검색하세요">
...
<div class="nav">
    <div class="nav-inner">
        ...
        <a href="${cp}/book/list?categoryId=1">소설</a>
        <a href="${cp}/book/list?categoryId=2">IT</a>
        <a href="${cp}/book/list?categoryId=3">자기계발</a>
    </div>
</div>